...
activity_l2_3 = 0.0001
activity_l2_4 = 0.0001
activity_l2_5 = 0.0001
activity_l2_6 = 0.0001
l2_0 = 0.0001
l2_1 = 0.0001
l2_2 = 0.0001
l2_3 = 0.0001
...
for i in range(max(folds.keys())+1):
    ...
    model.add(Dense(Dense_size4, activation='sigmoid',W_regularizer=l2(l2_3),activity_regularizer=activity_l2(activity_l2_3)))
    model.add(Dense(Dense_size5, activation='sigmoid',W_regularizer=l2(l2_4),activity_regularizer=activity_l2(activity_l2_4)))
    model.add(Dense(Dense_size6, activation='sigmoid',W_regularizer=l2(l2_5),activity_regularizer=activity_l2(activity_l2_5)))
    model.add(Dense(out_dim, activation='linear',W_regularizer=l2(l2_6),activity_regularizer=activity_l2(activity_l2_6)))
